  ...
  return (
    <div>
      ...
      <section id="home" className=" h-screen  content-section">
        <div
          id="hero-text"
          className="flex-col flex justify-center -mt-20 max-sm:-mt-[9rem] h-screen "
        >
          <div className="text-mute-beige tracking-tighter text-5xl justify-center flex flex-col items-center px-24 -z-10">
            <div className="max-sm:leading-12">
              ...
              <div>
                ...
                <h1 className="max-w-2xl font-normal text-8xl leading-24 text-left meets max-sm:text-[2.9rem] max-sm:leading-1 max-sm:-mt-0 max-[450px]:text-[2.6rem] max-[420px]:text-[2.6rem] max-[390px]:text-[2.4rem]">
                  MEETS CODE
                </h1>
              </div>
            </div>
