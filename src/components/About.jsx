  ...
  return (
    <div className="text-mute-beige  mx-24 mb-24 justify-center flex ml-48 max-sm:ml-24">
      <div className="flex flex-col w-[72rem] justify-start max-w-7xl">
        ...
        <div className="text-6xl max-w-6xl max-sm:w-[25rem] leading-16 text-left max-md:text-2xl max-lg:text-3xl max-lg:leading-12 max-md:leading-10 mb-10 text-to-animate max-sm:text-[1.6rem] max-sm:leading-10 max-sm:-mt-0">
