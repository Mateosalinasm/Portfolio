          ...
          <div className="rounded-2xl  w-[65rem] max-sm:w-[26rem]">
            <div className="flex justify-center max-sm:gap-2 -z-10 gap-y-4 max-sm:gap-y-6 flex-wrap">
              <div className="rounded-2xl">
                <Carousel
                  className="w-[53rem] h-[47rem] max-sm:w-[23rem] max-[550px]:w-[21rem] max-sm:h-[38rem]"
                  showThumbs={true}
                  showStatus={false}
                  showArrows={false}
                  emulateTouch={true}
                ...
                >
                  {projects.map((project, index) => (
                    <div key={index} className="rounded-2xl">
                      <div className="w-[50rem] mx-5 max-sm:w-[21rem] max-[550px]:w-[19rem] max-sm:pt-6 mb-[4rem] max-sm:mb-[4.5rem]">
