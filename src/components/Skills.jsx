...
const Skills = () => {
  return (
    <div className="flex justify-center mb-20">
      <div className="flex flex-col w-[72rem] justify-start ml-48 max-sm:ml-[5.5rem]  mx-24">
        <p
          id="about"
          className="text-mute-beige relative text-sm font-extralight tracking-[0.4em] mb-6"
        >
          SKILLS
        </p>
        <div className="font-extrabold text-5xl relative -left-2  selection:leading-16 text-left mb-10">
          <div className="flex  gap-8 flex-wrap ">
            {/* HTML */}
            <svg viewBox="0 0 128 128" className="h-20">
              <path
                fill="#E44D26"
